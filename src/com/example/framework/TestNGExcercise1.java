...
import com.example.freamework.pages.CalculatorHomePage;
...
@Test
public class TestNGExcercise1 extends TestCommands {
  ...
  //public void beforeMethod(String browser) {
	/*  public void setUp(String browser) throws Exception {
	  ...
	  public Object[][] dt_test002(){
		  ReadFromExcel reader = new ReadFromExcel("data"+File.separator+"PercentageData.xlsx", "DataTable1");
  ...
  @Test(dataProvider="dt_test001")
	  ...
	  /*##################################################################################################################################*/
	  		...
	  		calHome.calculatePercentage(driver,"5","300");
	  		
	  		calHome.verfyPercentage(driver, "15");
  }
